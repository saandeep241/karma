...
class KarmaOrchestrator:
    ...
    async def break_task_into_steps(
        ...
        """
        Break a task into steps using the Breakdown agent.
        ...
        """
        print(f"\n🎯 Orchestrator: Breaking down '{task.text[:40]}...' into steps...")
        ...
        try:
            ...
            print(f"✅ Orchestrator: Created {breakdown.total_steps} steps")
