...
def _get_outdoor_recommendation(current: dict) -> str:
    ...
    try:
        ...
        if "rain" in condition:
            return "Rain expected - bring an umbrella or reschedule outdoor activities"
        if "snow" in condition:
            return "Snowy conditions - dress warmly and be careful outdoors"
        ...
        if temp > 15:
            return "Nice weather - perfect for being outside"
