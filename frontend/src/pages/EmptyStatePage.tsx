...
export function EmptyStatePage() {
  ...
  return (
    <div className="flex flex-col items-center animate-fade-in max-w-4xl mx-auto pt-8 sm:pt-16 md:pt-24 px-4 min-h-[calc(100vh-80px)]">
      <div className="w-full max-w-xl bg-white rounded-3xl border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-8 sm:p-10">
        <div className="text-center mb-8">
          <h1 className="font-sans font-bold text-2xl sm:text-3xl text-[#001a41] leading-tight mb-3">
        ...
        <button className="w-full bg-[#0066cc] hover:bg-[#0052a3] text-white py-3.5 rounded-full text-base font-bold transition-all shadow-[0_8px_24px_rgba(0,102,204,0.25)]">
          Save & Continue
        </button>
      </div>
    </div>
