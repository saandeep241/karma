...
function App() {
  ...
  // If Clerk is not configured, show app without auth (simulating signed out state with new design)
  return (
    <QueryClientProvider client={queryClient}>
      <div className="min-h-screen flex items-center justify-center bg-[#f0f4f9] px-4">
        <div className="text-center w-full max-w-[400px]">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-2xl border border-gray-100 text-left">
            ...
            <button className="w-full flex items-center justify-center gap-3 py-2.5 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors mb-4 font-medium text-gray-700">
            ...
            <button className="w-full bg-[#001a41] hover:bg-black text-white py-2.5 rounded-lg font-medium transition-colors mb-6 shadow-sm">
              Continue
            </button>
